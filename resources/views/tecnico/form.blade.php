<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::label('finicio') }}
            {{ Form::text('finicio', $tecnico->finicio, ['class' => 'form-control' . ($errors->has('finicio') ? ' is-invalid' : ''), 'placeholder' => 'Finicio']) }}
            {!! $errors->first('finicio', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('sexo') }}
        ...
        <div class="form-group">
            {{ Form::label('cargo') }}
            {{ Form::text('cargo', $tecnico->cargo, ['class' => 'form-control' . ($errors->has('cargo') ? ' is-invalid' : ''), 'placeholder' => 'Cargo']) }}
